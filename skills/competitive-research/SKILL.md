...
2. Añade al final una sección **"Resumen para el consultor"** con:
   - Número de competidores analizados en profundidad
   - Número de [GAP] detectados y el más importante resumido en una frase
...
3. El contenido validado se guarda como `[Cliente] - Competitive Research v1.md` en `01 Entregables`. El orquestador lo registra en el State Log. Siguiente skill: `revenue-diagnostic`.
