...
2. Añade al final una sección **"Resumen para el consultor"** con:
   ...
   - Número de cuellos de botella identificados y el cuello de botella crítico
...
3. El contenido validado se guarda como `[Cliente] - Revenue Diagnostic v1.md` en `01 Entregables`. El orquestador lo registra en el State Log. Siguiente skill: diagnostic-checkpoint.
