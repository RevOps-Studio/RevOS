...
3. El contenido validado se guarda como `[Cliente] - Sales Conversion Design v1.md` en `01 Entregables`. El orquestador lo registra en el State Log. Siguiente skill: `execution-roadmap-builder`.
