...
2. Añade al final una sección **"Resumen para el consultor"** con:
   - Número de canales seleccionados y sus nombres
...
3. El contenido validado se guarda como `[Cliente] - Channel Strategy v1.md` en `01 Entregables`. El orquestador lo registra en el State Log. Siguiente skill: `content-discoverability-design`.
